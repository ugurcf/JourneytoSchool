...
namespace JourneytoSchool
{
    public partial class TestForm : Form
    {
        ...
        private void btnTest_Click(object sender, EventArgs e)
        {
            ...
            if(Age>20 && Age<30 && Dist>0 && Dist<0.9 && Friend > 1){
                lblResult.Text = "%58.9 Walk";
            }
            if (Age > 20 && Age < 30 && Dist > 0 && Dist < 3.9 && Friend >= 1)
            {
                lblResult.Text = "%65.9 Car";
            }
            if (Age > 20 && Dist >= 4 && Dist <10  && Friend >= 1)
            {
                lblResult.Text = "%90.3 Car";
            }
